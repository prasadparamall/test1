...
public class TestConfig{
	...
	public static String from = "testsmtpdemo777@gmail.com";
	public static String password = "mtbemdrqqlzbdspj";
	public static String[] to ={"testsmtpdemo777@gmail.com","testsmtpdemo777@gmail.com"};
